...
// ../../.wrangler/tmp/pages-ezKmvj/functionsWorker-0.24249726797783744.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var JSON_HEADERS = { "content-type": "application/json; charset=utf-8" };
var json = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), { status, headers: JSON_HEADERS }), "json");
var CAMPOS = ["nombre", "telefono", "email", "servicio"];
async function onRequestPost({ request, env }) {
  ...
  const esc = /* @__PURE__ */ __name2((v) => String(v).replace(/[<>&]/g, (c) => ({ "<": "&lt;", ">": "&gt;", "&": "&amp;" })[c]), "esc");
  const cuerpo = [
    `Nombre:   ${esc(datos.nombre)}`,
    `Tel\xE9fono: ${esc(datos.telefono)}`,
    `Email:    ${esc(datos.email)}`,
    `Servicio: ${esc(datos.servicio)}`,
    "",
    `Origen:   ${esc(request.headers.get("referer") || "desconocido")}`,
    `Pa\xEDs:     ${esc(request.headers.get("cf-ipcountry") || "desconocido")}`
  ].join("\n");
  try {
    const r = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        subject: `Nueva solicitud de informaci\xF3n \u2014 ${esc(datos.servicio)}`,
        text: cuerpo
      })
    });
    if (!r.ok) {
...
var BLOQUEADOS_PREFIJO = ["/portal-cliente/"];
var BLOQUEADOS_EXACTOS = /* @__PURE__ */ new Set([
  "/AUDITORIA.md",
  "/HALLAZGOS.md",
  "/INFORME-FINAL.md",
  "/MOTION.md",
...
async function paginaNoEncontrada(env, url) {
  ...
  return new Response("404 \u2014 p\xE1gina no encontrada", {
    status: 404,
...
async function onRequest(context) {
  ...
  if (BLOQUEADOS_EXACTOS.has(path) || BLOQUEADOS_PREFIJO.some((p) => path.startsWith(p))) {
...
// ../../AppData/Local/Temp/claude/c--Users-Asus-Desktop-APFCLAUDE/846575bf-2293-4746-8e3e-6fcdd61b2921/scratchpad/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../AppData/Local/Temp/claude/c--Users-Asus-Desktop-APFCLAUDE/846575bf-2293-4746-8e3e-6fcdd61b2921/scratchpad/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-3g2gUd/middleware-insertion-facade.js
...
// ../../AppData/Local/Temp/claude/c--Users-Asus-Desktop-APFCLAUDE/846575bf-2293-4746-8e3e-6fcdd61b2921/scratchpad/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-3g2gUd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.24249726797783744.js.map
